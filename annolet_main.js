...
function add_tagging()
{
  ...
  $j("head").append('<script src="https://rawgit.com/vikaskamineni/SSAD_demo/master/tagging.js">    </script>');
...
function add_func_tagging()
{
    ...
    $j("head").append('<script src="https://rawgit.com/vikaskamineni/SSAD_demo/master/my_tagging.js">    </script>');
...
function add_search_tagging()
{
    ...
    $j("head").append('  <script src="https://rawgit.com/vikaskamineni/SSAD_demo/master/search_function.js"></script>');
